  ...
  <div className="relative isolate z-0 bg-white px-6 pt-14 lg:px-8">
    <div className="relative mx-auto max-w-2xl py-24">
      ...
      <div className="text-center">
        <h1 onClick={()=>onTestClick} className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
        Connect Communicate Anonymously
        </h1>
        <p className="mt-6 text-lg leading-8 text-gray-600">
        Create an Account, Generate Your Link, and Hear Honest Anonymous Reviews
        </p>
